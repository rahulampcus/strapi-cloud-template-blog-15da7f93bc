...
export interface ApiLakeVisitLakeVisit extends Struct.CollectionTypeSchema {
...
export interface ApiVisitReportVisitReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dissolved_oxygen: Schema.Attribute.Decimal;
    inflow_outflow_status: Schema.Attribute.String;
